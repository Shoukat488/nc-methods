...
int main() {
   ...
   cout << "formula: " << endl;
   cout << "f'(x) = (1/12h) * [f(x-2h) - 8f(x-h) + 8f(x + h) -f(x+2h)]" << endl;

   printf("f'(%.6g) = (1/12(%.6g)) * [f(%.6g-2(%.6g)) - 8f(%.6g-%.6g) + 8f(%.6g+%.6g) - f(%.6g+2(%.6g))]\n", x, h, x, h, x, h, x, h, x, h);

   printf("f'(%.6g) = %.6g * [f(%.6g) - 8f(%.6g) + 8f(%.6g) - f(%.6g)]\n", x, (1/(12*h)), x - 2 * h, x - h, x + h, x + 2 * h);

   printf("f'(%.6g) = %.6g * [%.6g - 8(%.6g) + 8(%.6g) - %.6g]\n", x, (1/(12*h)), f(x - 2 * h), f(x - h), f(x + h), f(x + 2 * h));

   printf("f'(%.6g) = %.6g", x, (1/(12 * h)) * (f(x - 2 * h) - (8 * f(x - h)) + (8 * f(x + h)) - f(x + 2 * h)));
